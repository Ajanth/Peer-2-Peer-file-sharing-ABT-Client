...
LRESULT CTextProgressCtrl::OnSetText( UINT, LPARAM szText )
{
...
LRESULT CTextProgressCtrl::OnGetText( UINT cchTextMax, LPARAM szText )
{
    if ( !_tcsncpy_s( (LPTSTR)szText,MAX_PATH, m_strText, cchTextMax ) )
        return 0;
    else
...
int CTextProgressCtrl::OnCreate( LPCREATESTRUCT lpCreateStruct )
{
    ...
    //COMCTL_SET_UNICODE( GetSafeHwnd() );
